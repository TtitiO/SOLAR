"""Benchmark Tb and Tk for 021_vision_cu_seqlens_variable_length_attention (sol_execbench_l1_021)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l1_021")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l1_021")
    print("=" * 60)
    print(f"  Operator  : 021_vision_cu_seqlens_variable_length_attention")
