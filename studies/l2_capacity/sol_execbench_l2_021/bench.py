"""Benchmark Tb and Tk for 021_cross_attention_text_video_conditioning_backward (sol_execbench_l2_021)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l2_021")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l2_021")
    print("=" * 60)
    print(f"  Operator  : 021_cross_attention_text_video_conditioning_backward")
