"""Benchmark Tb and Tk for 075_grouped_query_self_attention_with_rope (sol_execbench_l1_075)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l1_075")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l1_075")
    print("=" * 60)
    print(f"  Operator  : 075_grouped_query_self_attention_with_rope")
