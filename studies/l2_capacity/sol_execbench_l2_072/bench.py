"""Benchmark Tb and Tk for 072_region_aware_self_attention_with_edit_bias_backward (sol_execbench_l2_072)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l2_072")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l2_072")
    print("=" * 60)
    print(f"  Operator  : 072_region_aware_self_attention_with_edit_bias_backward")
