"""Benchmark Tb and Tk for 046_attention_softmax_with_softcapping_and_dropout (sol_execbench_l1_046)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l1_046")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l1_046")
    print("=" * 60)
    print(f"  Operator  : 046_attention_softmax_with_softcapping_and_dropout")
