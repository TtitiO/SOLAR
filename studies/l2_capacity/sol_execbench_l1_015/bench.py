"""Benchmark Tb and Tk for 015_grouped_query_attention_with_rope_and_qk_norm (sol_execbench_l1_015)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l1_015")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l1_015")
    print("=" * 60)
    print(f"  Operator  : 015_grouped_query_attention_with_rope_and_qk_norm")
