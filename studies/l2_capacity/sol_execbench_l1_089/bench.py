"""Benchmark Tb and Tk for 089_vae_attention_block_with_groupnorm (sol_execbench_l1_089)."""
...
def main():
    print("=" * 60)
    print("BENCHMARK: sol_execbench_l1_089")
    print("=" * 60)
    ...
    print("BENCHMARK: sol_execbench_l1_089")
    print("=" * 60)
    print(f"  Operator  : 089_vae_attention_block_with_groupnorm")
